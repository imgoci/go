...
| 008 | 2026-08-17 | Release v0.1.0 against spec v0.1.0 | complete | Pinned the stable spec v0.1.0 with the decoupled versioning policy (PR #24), cleared the Dependabot alerts (PR #25), refreshed the README (PR #26), and shipped the verified first release v0.1.0 by merging PR #9. |
