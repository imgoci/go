...
//     JSON types for known members. Unknown members are tolerated so
//     additional-members.json and future extensions pass. All annotation keys,
//     including unknown keys, are preserved verbatim.
...
// [Model], sorts descriptors by the five-field UTF-8 tuple, and canonical-encodes
// through [github.com/imgoci/go/internal/jcs.Encode].
package index
