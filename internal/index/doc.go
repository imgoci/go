...
// [Model], applies producer-only registry and annotation-location rules that
// [Validate] does not, sorts descriptors by the five-field UTF-8 tuple, and
// encodes RFC 8785-canonical bytes with
// [github.com/imgoci/go/internal/jcs.Encode]. Spec §6 and §12 require a
// consumer to accept producer-only violations.
package index
